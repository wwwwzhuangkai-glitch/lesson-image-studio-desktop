...
class EditJob(Base):
    ...
    provider: Mapped[str] = mapped_column(String(32), nullable=False, default="openai_official")
    model: Mapped[str] = mapped_column(String(64), nullable=False, default="gpt-image-2")
    quality: Mapped[str] = mapped_column(String(16), nullable=False, default="high")
    size: Mapped[str] = mapped_column(String(32), nullable=False, default="auto")
...
class AppSettings(TimestampMixin, Base):
    ...
    default_provider: Mapped[str] = mapped_column(String(32), nullable=False, default="openai_official")
    tal_service_base_url: Mapped[str] = mapped_column(String(512), nullable=False, default="")
    tal_service_api_key: Mapped[str | None] = mapped_column(Text, nullable=True)
